...
ggplot(data=hits) + geom_histogram(aes(x=hour), bins=24*4) + xlab("Temps") + ylab("Nombre de messages") + labs(title="Messages échangés") + scale_x_datetime(breaks = date_breaks("1 month"))